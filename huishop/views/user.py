...
from huishop.utils import flash_errors, render_extensions
from huishop.forms.user import PasswordForm, EmailForm, UsernameForm
from huishop.extensions import mail
...
def reset():
    ...
    if form.validate_on_submit():
        ...
        from huishop.settings import Config
